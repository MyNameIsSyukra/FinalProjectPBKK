    ...
    <div class="row" style="margin: 10vh;">
        <div class="col-6 offset-3">
            <div class="container border rounded" style="background-color:cadetblue;">
                ...
                <form method="POST" action="/homepages/orderNow/{{$id}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    {{-- Nama --}}
                    <div class="m-3">
                        <label for="quantity" class="form-label">q</label>
                    ...
                    <div class="m-3">
                        <label for="Status_Payment" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="Status_Payment" name="Status_Payment" required>
                        @error('nama')
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="m-3">
                        <label for="screenshot" class="form-label">Foto</label>
